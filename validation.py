...
class ModelValidator:
    ...
    def _log_to_wandb(self, metrics: ValidationMetrics, global_step: int):
        ...
        ax.scatter(
            np.repeat(metrics.spanwise_distribution['z_coordinates'][:, np.newaxis], metrics.spanwise_distribution['error_distribution'].shape[1], axis=1),
